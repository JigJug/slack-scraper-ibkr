...
async function placeOrder(api: Client, contract: Contract, order: () => Order) {
...
async function sendOrders(
  ...
  try {
    ...
    //market order
    const parentId = await makeOrder("MARKET", api, contract, orderSize, {
      orderOptions,
    });
